...
public class ShaderHelper {
    ...
    private static int compileShader(int type, String shaderCode) {
        ...
        glShaderSource(shaderObjectId, shaderCode); // Tells ogl to associate the code in shaderCode with shader object sOId
        glCompileShader(shaderObjectId); //Compiles the shader.
